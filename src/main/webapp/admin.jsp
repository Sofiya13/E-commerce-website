...
body {
	...
	background-image:
		url('https://wallup.net/wp-content/uploads/2016/05/25/20766-texture-clothing.jpg');
	background-size: cover;
	background-repeat: no-repeat;
	/* Set the background size to cover the full page */
...
.card {
	...
	background-image:
		url('https://www.solidsmack.com/wp-content/uploads/2007/07/blue-shade.png');
	/* Use a relative path if the image is in the same directory as your HTML file */
	background-size: cover; /* Adjust background size if needed */
	background-position: top;
}

@
keyframes cardAnimation { 0% {
	transform: scale(0);
}
...
<body>
	<div class="top-menu">
		<div class="menu-icon">
			<a href="#" class='bx bx-arrow-back'></a>
		</div>
		<div class="logo">
			<img src="images/logo1.png" alt="Logo" width="200" height="100"
		...
		<div class="row">
			...
			<div class="col-lg-4 col-md-6">
				<div class="card">
					<div class="card-header">
						<center>
							<img src="https://cdn.onlinewebfonts.com/svg/img_229758.png"
								alt="image" width="120" />
						</center>
					</div>
					<div class="card-body">
						<a href="Admin_history" class="btn btn-primary btn-lg btn-block ">View
							history</a>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-6">
				<div class="card">
					<div class="card-header">
						<center>
							<img
								src="https://thumbs.dreamstime.com/b/peri%C3%B3dico-l%C3%ADnea-icono-de-las-noticias-ejemplo-plano-simple-moderno-del-vector-para-el-app-m%C3%B3vil-sitio-web-o-mesa-129681986.jpg"
								alt="image" width="150" height="120" />
						</center>
					</div>
					<div class="card-body">
						<a href="Admin_all_challanview"
							class="btn btn-primary btn-lg btn-block ">View Challan</a>
					</div>
				</div>
			</div>
		</div>
